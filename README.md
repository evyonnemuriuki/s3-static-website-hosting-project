...
## 4. Allow public access to the website.
      - Enable public access in the bucket settings
Under the **Permissions** tab of the S3 bucket, turn off the *block all public access* setting.
![*Block public access* turned off](screenshots\block public access- off.png)
